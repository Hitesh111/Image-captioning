...
"""## Downloading and prepareing the MS-COCO dataset"""
...
"""## Initializeing InceptionV3 and load the pretrained Imagenet weights

To do so, I'll create a tf.keras model where the output layer is the last convolutional layer in the InceptionV3 architecture. 
...
"""## Trying  to genrate captions on diffrent images
...
image_url = 'https://defenders.org/sites/default/files/styles/homepage-feature-2015/public/grizzley-bear_jim-chagares.png'
